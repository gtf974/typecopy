...
let getUrlParams = () => {
    ...
    if(param) defaultInput = param.replace(/%20/g, " ").replace(/%10/g, "+");
};
...
document.addEventListener('copy', e => {
    e.clipboardData.setData('text/plain', "https://typecopy.netlify.app/?t="+main.textContent.replace(/ /g, "%20").replace(/\+/g, "%10"));
    copied();
    e.preventDefault();
});